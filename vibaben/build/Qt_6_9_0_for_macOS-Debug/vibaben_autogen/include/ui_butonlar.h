/********************************************************************************
** Form generated from reading UI file 'butonlar.ui'
**
...
#ifndef UI_BUTONLAR_H
#define UI_BUTONLAR_H
...
public:
    ...
    void setupUi(QDialog *Butonlar)
    {
        if (Butonlar->objectName().isEmpty())
            Butonlar->setObjectName("Butonlar");
        Butonlar->resize(1024, 640);
        QPalette palette;
...
#endif
        Butonlar->setPalette(palette);
        pushButton = new QPushButton(Butonlar);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(170, 190, 321, 121));
        QFont font;
...
"}\n"
""));
        pushButton_2 = new QPushButton(Butonlar);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(510, 190, 321, 121));
...
"}\n"
""));
        pushButton_3 = new QPushButton(Butonlar);
        pushButton_3->setObjectName("pushButton_3");
        pushButton_3->setGeometry(QRect(170, 330, 321, 121));
...
"}\n"
""));
        pushButton_4 = new QPushButton(Butonlar);
        pushButton_4->setObjectName("pushButton_4");
        pushButton_4->setGeometry(QRect(510, 330, 321, 121));
...
""));
        ...
        retranslateUi(Butonlar);

        QMetaObject::connectSlotsByName(Butonlar);
    } // setupUi

    void retranslateUi(QDialog *Butonlar)
    {
...
namespace Ui {
    class Butonlar: public Ui_Butonlar {};
} // namespace Ui

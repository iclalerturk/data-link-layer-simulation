...
public:
    ...
    void setupUi(QDialog *DosyaAcma)
    {
        ...
        btn_dosyaAc->setGeometry(QRect(600, 70, 111, 41));
        ...
        pushButton->setGeometry(QRect(760, 100, 231, 81));
        pushButton->setFont(font);
        pushButton_2 = new QPushButton(DosyaAcma);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(760, 10, 231, 81));
        pushButton_2->setFont(font);
        labelFrame = new QLabel(DosyaAcma);
        labelFrame->setObjectName("labelFrame");
        labelFrame->setGeometry(QRect(320, 200, 681, 51));
        ...
        labelTitle->setGeometry(QRect(40, 200, 231, 51));
        ...
        label_2->setGeometry(QRect(40, 160, 221, 31));
        label_2->setFont(font);
        label_3 = new QLabel(DosyaAcma);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(320, 160, 191, 31));
        label_3->setFont(font);
        labelAnaVeri = new QLabel(DosyaAcma);
        labelAnaVeri->setObjectName("labelAnaVeri");
        labelAnaVeri->setGeometry(QRect(40, 280, 271, 321));
        labelAnaVeri->setFrameShape(QFrame::Shape::Box);
        labelAnaVeri->setLineWidth(5);
        labelAnaVeri->setWordWrap(true);
        frameContainer = new QWidget(DosyaAcma);
        frameContainer->setObjectName("frameContainer");
        frameContainer->setGeometry(QRect(360, 280, 631, 331));
    ...
    void retranslateUi(QDialog *DosyaAcma)
    {
        ...
        pushButton->setText(QCoreApplication::translate("DosyaAcma", "Dosyay\304\261 G\303\266ndermeye\n"
"Ba\305\237la", nullptr));
        pushButton_2->setText(QCoreApplication::translate("DosyaAcma", "Veriyi 100 Bitlik\n"
"Par\303\247alara B\303\266l", nullptr));
        labelFrame->setText(QString());
        labelTitle->setText(QString());
        label_2->setText(QCoreApplication::translate("DosyaAcma", "Olu\305\237turulan Par\303\247a Say\304\261s\304\261", nullptr));
        label_3->setText(QCoreApplication::translate("DosyaAcma", "Olu\305\237turulan Par\303\247alar", nullptr));
        labelAnaVeri->setText(QString());
    } // retranslateUi
